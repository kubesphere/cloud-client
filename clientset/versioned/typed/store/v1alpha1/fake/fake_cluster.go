...
var clustersResource = schema.GroupVersionResource{Group: "store.kubesphere.cloud", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "store.kubesphere.cloud", Version: "v1alpha1", Kind: "Cluster"}
